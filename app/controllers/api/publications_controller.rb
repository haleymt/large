module Api
  class PublicationsController < ApplicationController
    ...
    def show
      @pub = Publication.includes(:stories, :followers, :tags, :taggings).find(params[:id])
    ...
    private
      def pub_params
        params.require(:publication).permit(:title, :owner_id, :description, :header_image, :icon_image, :header_align)
      end
    end
